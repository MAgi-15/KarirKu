    ...
    <View style={{ padding:20 }}>
        ...
        <View style={{ paddingHorizontal:20, paddingVertical:15, flexDirection:'row', alignItems:'center', marginBottom:10 }}>
            <View style={{ marginRight:10 }}>
                <Feather name='user' size={27} color={'#797979'}></Feather>
            </View>
            <View>
                <TextInput value = {username} onChangeText = {(username)=>{Username(username)}} style={{ fontFamily:'Poppins-Light', fontSize:16, color: "#696969", borderBottomWidth:1, borderColor:'#B5B5B5', width:280, paddingBottom:0 }} placeholder={'Username'}></TextInput>
            </View>
        </View>
        <View style={{ paddingHorizontal:20, paddingVertical:15, flexDirection:'row', alignItems:'center', marginBottom:10 }}>
            <View style={{ marginRight:10 }}>
            ...
            <View>
                <TextInput value = {email} onChangeText = {(email)=>{Email(email)}} style={{ fontFamily:'Poppins-Light', fontSize:16, color: "#696969", borderBottomWidth:1, borderColor:'#B5B5B5', width:280, paddingBottom:0 }} placeholder={'Email'}></TextInput>
            </View>
        </View>
        <View style={{ paddingHorizontal:20, paddingVertical:15, flexDirection:'row', alignItems:'center', marginBottom:70 }}>
            ...
            <View>
                <TextInput value = {pass} onChangeText = {(pass)=>{Password(pass)}} secureTextEntry style={{ fontFamily:'Poppins-Light', fontSize:16, color: "#696969", borderBottomWidth:1, borderColor:'#B5B5B5', width:280, paddingBottom:0 }} placeholder={'Password'}></TextInput>
            </View>
        </View>

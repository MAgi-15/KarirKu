...
const Header = ({navigation})=> (
    <View style={{ backgroundColor:'white', paddingHorizontal:30, paddingTop:20, paddingBottom:10, flexDirection:'row', alignItems:'center', justifyContent:'space-between', elevation:4,zIndex:9, marginBottom:20 }}>

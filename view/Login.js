...
const Form = ({navigation})=> (
    <View style={{ padding:20 }}>
        <View style={{ alignItems:'center', marginBottom:10 }}>
            ...
            <Text style={{ fontFamily:'Poppins-Medium', fontSize:24, color:'black' }}>Login</Text>
        </View>
        ...
        <BaseButton style={{ alignItems:'center', marginBottom:20 }} onPress={()=>{navigation.navigate('Home')}}>
